...
* **Nội dung:**
Trong Session 5 – Multi-Page Application, tôi đã tìm hiểu và thực hành xây dựng ứng dụng nhiều trang bằng React Router. Nội dung bao gồm:
Tìm hiểu cách cài đặt và sử dụng React Router trong ứng dụng React.
Sử dụng Route để định nghĩa các đường dẫn và hiển thị component tương ứng.
Sử dụng Navigate để thực hiện chuyển hướng giữa các trang.
Tìm hiểu và áp dụng Route Parameters để truyền dữ liệu thông qua URL.
Xây dựng các trang:
Trang chủ (/)
...
Thiết lập hệ thống điều hướng giữa các trang và kiểm tra hoạt động của từng route.
* **Kết quả đạt được:**
Sau khi hoàn thành bài thực hành :

Hiểu được nguyên lý hoạt động của React Router trong React.
Tạo và cấu hình thành công các route cho ứng dụng nhiều trang.
Thực hiện điều hướng giữa các trang mà không cần tải lại toàn bộ website.
Sử dụng được Navigate để chuyển hướng người dùng.
Áp dụng được Route Parameters để lấy dữ liệu từ URL và hiển thị thông tin tương ứng.
Xây dựng thành công ứng dụng gồm các trang Home, Products, Product Detail, Cart và Login.
Nâng cao kỹ năng phát triển ứng dụng React theo mô hình Single Page Application (SPA).
